  ...
  return <AuthShell>
    <div className="mx-auto max-w-md py-1 sm:py-2">
      ...
      <form onSubmit={submit} className="mt-9 grid gap-5">
        ...
        <button disabled={busy} className="flex min-h-14 items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 px-4 font-semibold text-white shadow-lg shadow-blue-200 transition hover:from-blue-700 hover:to-blue-600 disabled:opacity-50"><span>{busy?copy.signingIn:copy.signIn}</span></button>
      </form>
