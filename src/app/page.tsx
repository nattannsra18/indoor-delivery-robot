...
export default function DashboardPage() {
  ...
  const issues = useMemo(() => buildIssues({ backendOnline, robotOnline: robot.online, occupancyMap: Boolean(occupancyMap), emergencyLatched: Boolean(emergencyStop?.latched), diagnostics, activeTask, tasks, locale }), [activeTask, backendOnline, diagnostics, emergencyStop?.latched, locale, occupancyMap, robot.online, tasks]);
