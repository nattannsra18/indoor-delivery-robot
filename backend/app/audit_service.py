...
ALLOWED_METADATA = frozenset({"task_status", "robot_id", "alert_id", "reason", "priority", "supervised_mode", "map_id", "new_map_id", "command_id", "enrollment_id", "profile_version", "credential_version"})
ALLOWED_ACTION_FILTERS = frozenset({"auth.login", "auth.logout", "auth.signup", "auth.account_approved", "auth.password_reset", "task.created", "task.dispatched", "task.cancel", "task.retry", "task.confirm_loaded", "task.confirm_received", "task.arrived_pickup", "task.arrived_destination", "task.navigation_failed", "alert.created", "alert.reopened", "alert.acknowledged", "alert.resolved", "emergency.activate_requested", "emergency.reset_requested", "emergency.activate_succeeded", "emergency.reset_succeeded", "emergency.command_failed", "robot.offline", "robot.online", "robot.recovered", "robot.connected", "robot.disconnected", "robot.enrollment_requested", "robot.enrollment_approved", "robot.enrollment_claimed", "robot.credential_revoked", "robot.archived", "robot.credential_rotation_requested", "robot.credential_rotated", "robot.credential_rotation_failed", "station.created", "station.updated", "station.deleted", "map.metadata_updated", "map.switch_requested", "map.switch_succeeded", "map.switch_failed", "map.update_metadata_requested", "map.update_metadata_succeeded", "map.update_metadata_failed", "map.rename_requested", "map.rename_succeeded", "map.rename_failed", "map.delete_requested", "map.delete_succeeded", "map.delete_failed", "mapping.start_requested", "mapping.save_requested", "mapping.command_succeeded", "mapping.command_failed"})
class AuditService:
