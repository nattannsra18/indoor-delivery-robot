...
ALLOWED_METADATA = frozenset({"task_status", "robot_id", "alert_id", "reason", "priority", "map_id", "new_map_id", "command_id", "enrollment_id", "profile_version", "credential_version"})
